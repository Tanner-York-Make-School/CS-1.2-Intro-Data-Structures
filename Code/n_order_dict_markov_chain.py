...
from dictogram.dictogram import Dictogram
...
class DictovChain(dict):
    ...
    def __init__(self, words_list, order=2):
        ...
        circular_buffer = CircularBuffer(order)
        prev_words = None
        for word in words_list:
            ...
            if circular_buffer[0] is not None:
                ...
                self.add_count(tuple(circular_buffer), tuple(prev_words))
